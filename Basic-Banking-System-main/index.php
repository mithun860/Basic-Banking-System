...
<html lang="en">
  ...
  ?>
            ...
            <div class="row intro py-1">
              <div class="col-sm-12 col-md">
                <div class="heading text-center my-5">
                  <h3>Welcome to</h3>
                  <h1>Sparks Bank</h1>
                  <h4>"Money in the Bank is like toothpaste in the tube.</h4>
                  <h5>Easy to take out, hard to put back."</h5>
                </div>
              </div>
      ...
      <footer class="text-center mt-5 py-2">
        <p>&copy 2021 Made by <b>Mithun Upadhyay</b> <br> The Sparks Foundation</p>
      </footer>
